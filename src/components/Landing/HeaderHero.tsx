      ...
      <section className="container flex flex-col-reverse lg:flex-row items-center py-10 lg:py-14">
        <div className="flex-1 items-start">
          ...
          <div className="flex flex-col lg:flex-row gap-3 lg:mt-10">
            <button type="button" className="w-full lg:w-[264px] h-[33px] lg:h-[66px] btn-red">
              <div className="text-xs lg:text-2xl text-bold text-white">Tryout JobFit Now</div>
            </button>
            <button type="button" className="w-full lg:w-[233px] h-[33px] lg:h-[66px] btn-white">
                <div className="text-xs lg:text-2xl text-bold text-crimson">Program Offers</div>
            </button>
          </div>
        </div>
